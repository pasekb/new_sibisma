...
<div class="col-md-12">
    <div class="card card-profile">
        <div class="card-header" style="background-image: url('{{ asset("img/bg-profile-yellow.jpg") }}')">
            ...
            <a href="{{ route('manpower.edit', $manpower->id) }}" data-toggle="tooltip" data-placement="top" title="Edit" style="color: #000; font-size: 20px; text-decoration: none; font-weight: bold;"><i class="fas fa-edit"></i> Edit</a>
        </div>
        <div class="card-body">
            <div class="user-profile text-center">
                ...
                <div class="desc" style="margin-top: -8px;">Resign on {{ $manpower->resign_date == "" ? '-' : \Carbon\Carbon::parse($manpower->resign_date)->format('jS F Y') }}</div>

            ...
            <form action="{{ route('unit.update', $unit->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group form-group-default">
                            <label>Color</label>
                            <p type="text" class="form-control" style="margin-bottom: -4px;">{{ $unit->color->color_name }}</p>
                        </div>
                        ...
                        <div class="form-group form-group-default">
                            <label>Price</label>
                            <p type="text" class="form-control" style="margin-bottom: -4px;">Rp {{  number_format($unit->price, 0, ',','.')  }}</p>
                        </div>
                    </div>
                </div>
            </form>

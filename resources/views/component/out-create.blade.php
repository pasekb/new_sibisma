...
<div class="col-md-12" id="dataCreate">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('out.store') }}" method="post" id="form">
                @csrf
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-floating-label">
                            <input id="out_date" type="date" class="form-control input-border-bottom" name="out_date"
                                value="{{ Session::has('input') ? Session::get('input.out_date') : $today }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-floating-label">
                            <input id="frame_no" type="text"
                                class="form-control input-border-bottom {{ Session::has('auto') ? 'is-invalid' : '' }}"
                                name="frame_no" value="{{ old('frame_no') }}" @if(Session::has('auto'))
                                autofocus="autofocus" onclick="this.select()" @endif style="text-transform: uppercase;"
                                required>

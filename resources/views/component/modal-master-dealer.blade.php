<div class="modal fade modalMasterDealer" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="display table table-striped table-hover" width="100%">
                        ...
                        <tbody>
                                @forelse($dealer as $o)
                                <tr data-id="{{ $o->id }}" data-code="{{ $o->dealer_code }}" data-name="{{ $o->dealer_name }}" class="pilihMasterDealer" style="background-color: <?php echo $o->dealer_code == 'YIMM' ? '#297bff50' : '' ?>;">
                                    <td>{{ $o->id }}</td>
                                    <td>{{ $o->dealer_code }}</td>
                                    <td>{{ $o->dealer_name }}</td>
                                </tr>
